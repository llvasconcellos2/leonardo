...
export const PROJECTS: Project[] = [
  {
    ...
    stakes: true,
    kicker: {
      en: "// medical records · doctors without borders",
      pt: "// prontuários · médicos sem fronteiras",
    },
    title: {
      en: "Ebola-response records system",
      pt: "Sistema de prontuários — resposta ao Ebola",
    },
    desc: {
    ...
    bullets: {
      en: [
        "Offline-first sync across field tablets",
        "Audit-grade record integrity",
        "Built under real operational pressure",
      ],
      pt: [
        "Sincronização offline-first entre tablets",
        "Integridade de registros auditável",
        "Construído sob pressão operacional real",
      ],
    },
  ...
  },
  {
    ...
    stakes: true,
    kicker: {
      en: "// smart city · itajaí",
      pt: "// cidade inteligente · itajaí",
    },
    title: {
      en: "Brazil's top-ranked smart city",
      pt: "A cidade inteligente nº 1 do Brasil",
    },
    desc: {
    ...
    bullets: {
      en: [
        "Untangled a years-deep legacy core",
        "Citizen-facing services at city scale",
        "Top national smart-city ranking",
      ],
      pt: [
        "Desembaraçou um núcleo legado de anos",
        "Serviços ao cidadão em escala municipal",
  ...
  },
  {
    ...
    stakes: true,
    kicker: {
      en: "// supply chain · bureau veritas",
      pt: "// cadeia de suprimentos · bureau veritas",
    },
    title: {
      en: "Global grain supply chains",
      pt: "Cadeias globais de grãos",
    },
    desc: {
    ...
    bullets: {
      en: [
        "Inspection data across continents",
        "Certification workflows for BASF/Bayer",
        "Reliable under heavy load",
      ],
      pt: [
        "Dados de inspeção entre continentes",
        "Fluxos de certificação BASF/Bayer",
        "Confiável sob carga pesada",
      ],
    },
  ...
  },
  {
    ...
    title: {
      en: "The world's largest educational software",
      pt: "O maior software educacional do mundo",
    },
    desc: {
    ...
    bullets: {
      en: [
        "Built for millions of students",
        "Performance budgets at scale",
        "Long-lived, maintained codebase",
      ],
      pt: [
        "Feito para milhões de alunos",
        "Orçamentos de performance em escala",
        "Base de código longeva e mantida",
      ],
    },
...
export const POSTS: Post[] = [
  {
    ...
    read: "8 min",
    kicker: {
      en: "// writing · engineering",
      pt: "// escrita · engenharia",
    },
    title: {
      en: "Crawling and self-hosting 70 dead sites",
      pt: "Rastreando e auto-hospedando 70 sites mortos",
    },
    excerpt: {
  ...
  },
  {
    ...
    title: {
      en: "Shipping across five eras of the web",
      pt: "Construindo através de cinco eras da web",
    },
    excerpt: {
  ...
  },
  {
    ...
    title: {
      en: "On untangling systems that have grown",
      pt: "Sobre desembaraçar sistemas que cresceram",
    },
    excerpt: {
...
export const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    seeAll: "See all ~70 projects",
    writing: "Writing",
    writingLead:
      "The engine. A prior site passed a million views — writing is the marketing that runs while asleep.",
    allWriting: "All writing",
    engineeredWith: "Engineered with",
    viewDetails: "View details",
    liveSnapshot: "Live snapshot",
    hireLead:
      "Open to good freelance and the right full-time role. Here's how to work with me.",
    contact: "Get in touch",
    resume: "Download résumé",
    archive: "Project archive",
    archiveLead: "~20 years · ~70 shipped projects · five eras of the web",
    back: "Back",
    readMore: "Read",
    minRead: "read",
  },
  pt: {
    ...
    seeAll: "Ver todos os ~70 projetos",
    writing: "Escrita",
    writingLead:
      "O motor. Um site anterior passou de um milhão de views — escrever é o marketing que roda enquanto durmo.",
    allWriting: "Toda a escrita",
    engineeredWith: "Construído com",
    viewDetails: "Ver detalhes",
    liveSnapshot: "Snapshot ao vivo",
    hireLead:
      "Aberto a bons freelas e à vaga full-time certa. Veja como trabalhar comigo.",
    contact: "Fale comigo",
    resume: "Baixar currículo",
    archive: "Arquivo de projetos",
    archiveLead: "~20 anos · ~70 projetos · cinco eras da web",
    back: "Voltar",
    readMore: "Ler",
    minRead: "leitura",
  },
